...
class PSBTUTIL_Test(unittest.TestCase):
    ...
    def test_generateSignedBuyPsbt(self):
        ...
        pyPsbt = generateSignedListingPsbt(listData,network,publicKey)
        publicKey = unhexlify('020209aae9897b9768fa633882f563003f21c83df0bad4e7b6df73700f042ff74cc4') #压缩公钥(x)： 通过私钥获取或前端传过来
        singature = unhexlify('30440220473cc9619943eeafaff743bcfeb0b821a98fdbcb41763ec10e0055d283fb68e202203a3173a6423a22a34f07868582cdc8327d7cbb47061bbbcd44673faf51c5cf9883') #签名 前端传回来
